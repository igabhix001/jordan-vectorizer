...
export declare function vectorizeRaw(source: Buffer, args: RawDataConfig, config?: Config | Preset | undefined | null): Promise<string>
export declare function vectorizeSync(source: Buffer, config?: Config | Preset | undefined | null): string
export declare function vectorizeRawSync(source: Buffer, args: RawDataConfig, config?: Config | Preset | undefined | null): string
